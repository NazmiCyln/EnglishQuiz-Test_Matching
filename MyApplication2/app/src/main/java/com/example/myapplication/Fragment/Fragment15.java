...
public class Fragment15 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment15.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment15.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment15.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Revolution", "Devrim", 0));
        solBölümList.add(new Tasarı("Empire", "İmparatorluk", 1));
        solBölümList.add(new Tasarı("Kingdom", "Krallık", 2));
        solBölümList.add(new Tasarı("Warrior", "Savaşçı", 3));
        solBölümList.add(new Tasarı("Republic", "Cumhuriyet", 4));
        solBölümList.add(new Tasarı("Corner", "Köşe", 5));
        solBölümList.add(new Tasarı("Equals", "Eşittir", 6));
        solBölümList.add(new Tasarı("Square", "Kare", 7));
        solBölümList.add(new Tasarı("Power", "Güç", 8));
        solBölümList.add(new Tasarı("Volume", "Hacim", 9));
        solBölümList.add(new Tasarı("Gravity", "Yerçekimi", 10));
        solBölümList.add(new Tasarı("Heat", "Isı", 11));
        solBölümList.add(new Tasarı("Trailer", "Fragman", 12));
        solBölümList.add(new Tasarı("Couple", "Çift", 13));
        solBölümList.add(new Tasarı("Straight", "Düz", 14));
        solBölümList.add(new Tasarı("Seagull", "Martı", 15));
