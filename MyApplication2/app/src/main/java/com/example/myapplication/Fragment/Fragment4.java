...
public class Fragment4 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment4.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment4.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment4.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Sweater", "Kazak", 0));
        solBölümList.add(new Tasarı("Dress", "Elbise", 1));
        solBölümList.add(new Tasarı("Shoes", "Ayakkabı", 2));
        solBölümList.add(new Tasarı("Hair", "Saç", 3));
        solBölümList.add(new Tasarı("Face", "Yüz", 4));
        solBölümList.add(new Tasarı("Body", "Gövde", 5));
        solBölümList.add(new Tasarı("Cold", "Soğuk", 6));
        solBölümList.add(new Tasarı("Ice", "Buz", 7));
        solBölümList.add(new Tasarı("Rain", "Yağmur", 8));
        solBölümList.add(new Tasarı("Neck", "Boyun", 9));
        solBölümList.add(new Tasarı("Ear", "Kulak", 10));
        solBölümList.add(new Tasarı("Kitchen", "Mutfak", 11));
        solBölümList.add(new Tasarı("Bathroom", "Banyo", 12));
        solBölümList.add(new Tasarı("Cherry", "Kiraz", 13));
        solBölümList.add(new Tasarı("Jogging", "Koşu", 14));
        solBölümList.add(new Tasarı("Rabbit", "Tavşan", 15));
