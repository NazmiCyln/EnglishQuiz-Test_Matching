...
public class Fragment6 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment6.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment6.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment6.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Grape", "Üzüm", 0));
        solBölümList.add(new Tasarı("Apricot", "Kayısı", 1));
        solBölümList.add(new Tasarı("Pear", "Armut", 2));
        solBölümList.add(new Tasarı("Egg", "Yumurta", 3));
        solBölümList.add(new Tasarı("Cheese", "Peynir", 4));
        solBölümList.add(new Tasarı("Cake", "Pasta", 5));
        solBölümList.add(new Tasarı("Tea", "Çay", 6));
        solBölümList.add(new Tasarı("Coffee", "Kahve", 7));
        solBölümList.add(new Tasarı("Sofa", "Kanepe", 8));
        solBölümList.add(new Tasarı("Carpet", "Halı", 9));
        solBölümList.add(new Tasarı("Plant", "Bitki", 10));
        solBölümList.add(new Tasarı("Picture", "Resim", 11));
        solBölümList.add(new Tasarı("Bed", "Yatak", 12));
        solBölümList.add(new Tasarı("Pillow", "Yastık", 13));
        solBölümList.add(new Tasarı("Bowl", "Kase", 14));
        solBölümList.add(new Tasarı("Bottle", "Şişe", 15));
