...
public class Fragment3 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment3.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment3.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment3.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Notebook", "Defter", 0));
        solBölümList.add(new Tasarı("Wood", "Tahta", 1));
        solBölümList.add(new Tasarı("Snow", "Kar", 2));
        solBölümList.add(new Tasarı("Rainbow", "Gökkuşağı", 3));
        solBölümList.add(new Tasarı("Sun", "Güneş", 4));
        solBölümList.add(new Tasarı("Skirt", "Etek", 5));
        solBölümList.add(new Tasarı("Shirt", "Gömlek", 6));
        solBölümList.add(new Tasarı("Leg", "Bacak", 7));
        solBölümList.add(new Tasarı("Arm", "Kol", 8));
        solBölümList.add(new Tasarı("Eye", "Göz", 9));
        solBölümList.add(new Tasarı("Room", "Oda", 10));
        solBölümList.add(new Tasarı("Garage", "Garaj", 11));
        solBölümList.add(new Tasarı("Roof", "Çatı", 12));
        solBölümList.add(new Tasarı("Garden", "Bahçe", 13));
        solBölümList.add(new Tasarı("Pool", "Havuz", 14));
        solBölümList.add(new Tasarı("Apple", "Elma", 15));
