...
public class Fragment5 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment5.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment5.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment5.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Trousers", "Pantolon", 0));
        solBölümList.add(new Tasarı("Coat", "Palto", 1));
        solBölümList.add(new Tasarı("Size", "Beden", 2));
        solBölümList.add(new Tasarı("Gloves", "Eldiven", 3));
        solBölümList.add(new Tasarı("Head", "Kafa", 4));
        solBölümList.add(new Tasarı("Foot", "Ayak", 5));
        solBölümList.add(new Tasarı("Shoulder", "Omuz", 6));
        solBölümList.add(new Tasarı("Tooth", "Diş", 7));
        solBölümList.add(new Tasarı("House", "Ev", 8));
        solBölümList.add(new Tasarı("Basement", "Bodrum", 9));
        solBölümList.add(new Tasarı("Snake", "Yılan", 10));
        solBölümList.add(new Tasarı("Melon", "Kavun", 11));
        solBölümList.add(new Tasarı("Banana", "Muz", 12));
        solBölümList.add(new Tasarı("Ceiling", "Tavan", 13));
        solBölümList.add(new Tasarı("Orange", "Portakal", 14));
        solBölümList.add(new Tasarı("Bread", "Ekmek", 15));
