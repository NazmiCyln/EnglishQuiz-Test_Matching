...
public class Fragment16 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment16.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment16.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment16.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Ashamed", "Mahcup", 0));
        solBölümList.add(new Tasarı("Awkward", "Beceriksiz", 1));
        solBölümList.add(new Tasarı("Awareness", "Farkındalık", 2));
        solBölümList.add(new Tasarı("Capable", "Yetenekli", 3));
        solBölümList.add(new Tasarı("Charming", "Cazibeli", 4));
        solBölümList.add(new Tasarı("Desperate", "Çaresiz", 5));
        solBölümList.add(new Tasarı("Encounter", "Rastlamak", 6));
        solBölümList.add(new Tasarı("Executive", "Yönetici", 7));
        solBölümList.add(new Tasarı("Founder", "Kurucu", 8));
        solBölümList.add(new Tasarı("Gorgeous", "Muhteşem", 9));
        solBölümList.add(new Tasarı("Impatient", "Sabırsız", 10));
        solBölümList.add(new Tasarı("Landscape", "Manzara", 11));
        solBölümList.add(new Tasarı("Opponent", "Rakip", 12));
        solBölümList.add(new Tasarı("Passionate", "Tutkulu", 13));
        solBölümList.add(new Tasarı("Preference", "Tercih", 14));
        solBölümList.add(new Tasarı("Robbery", "Hırsızlık", 15));
