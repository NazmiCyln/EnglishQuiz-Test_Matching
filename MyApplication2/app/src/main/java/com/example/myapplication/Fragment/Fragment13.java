...
public class Fragment13 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment13.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment13.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment13.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Straw", "Pipet", 0));
        solBölümList.add(new Tasarı("Kite", "Uçurtma", 1));
        solBölümList.add(new Tasarı("Marbles", "Misket", 2));
        solBölümList.add(new Tasarı("Engine", "Motor", 3));
        solBölümList.add(new Tasarı("Pollution", "Kirilik", 4));
        solBölümList.add(new Tasarı("Environment", "Çevre", 5));
        solBölümList.add(new Tasarı("Climate", "İklim", 6));
        solBölümList.add(new Tasarı("Evidence", "Delil", 7));
        solBölümList.add(new Tasarı("Prison", "Hapishane", 8));
        solBölümList.add(new Tasarı("Paint", "Boya", 9));
        solBölümList.add(new Tasarı("Art", "Sanat", 10));
        solBölümList.add(new Tasarı("Talent", "Yetenek", 11));
        solBölümList.add(new Tasarı("Abstract", "Soyut", 12));
        solBölümList.add(new Tasarı("Exhibit", "Sergi", 13));
        solBölümList.add(new Tasarı("Shipping", "Kargo", 14));
        solBölümList.add(new Tasarı("Factory", "Fabrika", 15));
