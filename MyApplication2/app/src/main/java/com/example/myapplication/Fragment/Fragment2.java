...
public class Fragment2 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment2.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment2.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment2.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Memory","Hafıza", 0));
        solBölümList.add(new Tasarı("Soup","Çorba", 1));
        solBölümList.add(new Tasarı("Local","Yerel", 2));
        solBölümList.add(new Tasarı("Support","Destek", 3));
        solBölümList.add(new Tasarı("Close","Kapat", 4));
        solBölümList.add(new Tasarı("Summer","Yaz", 5));
        solBölümList.add(new Tasarı("Winter","Kış", 6));
        solBölümList.add(new Tasarı("Paper","Kağıt", 7));
        solBölümList.add(new Tasarı("Map","Harita", 8));
        solBölümList.add(new Tasarı("Chair","Sandalye", 9));
        solBölümList.add(new Tasarı("Desk","Sıra", 10));
        solBölümList.add(new Tasarı("Calendar","Takvim", 11));
        solBölümList.add(new Tasarı("Printer","Yazıcı", 12));
        solBölümList.add(new Tasarı("Door","Kapı", 13));
        solBölümList.add(new Tasarı("Window","Pencere", 14));
        solBölümList.add(new Tasarı("Wallet","Cüzdan", 15));
