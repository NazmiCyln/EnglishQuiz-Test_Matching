...
public class Fragment14 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment14.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment14.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment14.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Brand", "Marka", 0));
        solBölümList.add(new Tasarı("Industry", "Fabrika", 1));
        solBölümList.add(new Tasarı("Invoice", "Fatura", 2));
        solBölümList.add(new Tasarı("Employer", "İşveren", 3));
        solBölümList.add(new Tasarı("Patient", "Hasta", 4));
        solBölümList.add(new Tasarı("Pain", "Acı", 5));
        solBölümList.add(new Tasarı("Pepper", "Biber", 6));
        solBölümList.add(new Tasarı("Garlic", "Sarımsak", 7));
        solBölümList.add(new Tasarı("Scale", "Ölçeklendirmek", 8));
        solBölümList.add(new Tasarı("Resolution", "Çözünürlük", 9));
        solBölümList.add(new Tasarı("Focus", "Odak", 10));
        solBölümList.add(new Tasarı("Crop", "Kırpmak", 11));
        solBölümList.add(new Tasarı("Frame", "Çerçeve", 12));
        solBölümList.add(new Tasarı("Quality", "Kalite", 13));
        solBölümList.add(new Tasarı("Text", "Metin", 14));
        solBölümList.add(new Tasarı("Literature", "Edebiyat", 15));
