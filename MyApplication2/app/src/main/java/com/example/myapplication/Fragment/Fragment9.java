...
public class Fragment9 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment9.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment9.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment9.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Grass", "Ot", 0));
        solBölümList.add(new Tasarı("Tree", "Ağaç", 1));
        solBölümList.add(new Tasarı("Leaf", "Yaprak", 2));
        solBölümList.add(new Tasarı("Farmer", "Çiftçi", 3));
        solBölümList.add(new Tasarı("Lawyer", "Avukat", 4));
        solBölümList.add(new Tasarı("Accountant", "Muhasebeci", 5));
        solBölümList.add(new Tasarı("Baker", "Fırıncı", 6));
        solBölümList.add(new Tasarı("Young", "Genç", 7));
        solBölümList.add(new Tasarı("Blonde", "Sarışın", 8));
        solBölümList.add(new Tasarı("Bald", "Kel", 9));
        solBölümList.add(new Tasarı("Between", "Arasında", 10));
        solBölümList.add(new Tasarı("About", "Hakkında", 11));
        solBölümList.add(new Tasarı("Under", "Altında", 12));
        solBölümList.add(new Tasarı("Clean", "Temizlemek", 13));
        solBölümList.add(new Tasarı("Find", "Bulmak", 14));
        solBölümList.add(new Tasarı("Take", "Almak", 15));
