...
public class Fragment12 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment12.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment12.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment12.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Advertisement", "Reklam", 0));
        solBölümList.add(new Tasarı("Hammer", "Çekiç", 1));
        solBölümList.add(new Tasarı("Cave", "Mağara", 2));
        solBölümList.add(new Tasarı("Customs", "Gümrük", 3));
        solBölümList.add(new Tasarı("Valley", "Vadi", 4));
        solBölümList.add(new Tasarı("Forest", "Orman", 5));
        solBölümList.add(new Tasarı("River", "Nehir", 6));
        solBölümList.add(new Tasarı("Desert", "Çöl", 7));
        solBölümList.add(new Tasarı("Coast", "Sahil", 8));
        solBölümList.add(new Tasarı("Island", "Ada", 9));
        solBölümList.add(new Tasarı("Waterfall", "Şelale", 10));
        solBölümList.add(new Tasarı("Iceberg", "Buzdağı", 11));
        solBölümList.add(new Tasarı("Continent", "Kıta", 12));
        solBölümList.add(new Tasarı("Planet", "Gezegen", 13));
        solBölümList.add(new Tasarı("Update", "Güncelleme", 14));
        solBölümList.add(new Tasarı("Upgrade", "Yükseltme", 15));
