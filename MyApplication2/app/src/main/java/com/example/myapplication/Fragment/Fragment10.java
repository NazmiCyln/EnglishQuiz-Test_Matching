...
public class Fragment10 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment10.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment10.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment10.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Butcher", "Kasap", 0));
        solBölümList.add(new Tasarı("Director", "Yönetmen", 1));
        solBölümList.add(new Tasarı("Fireman", "İtfaiyeci", 2));
        solBölümList.add(new Tasarı("Teacher", "Öğretmen", 3));
        solBölümList.add(new Tasarı("Want", "İstemek", 4));
        solBölümList.add(new Tasarı("Spend", "Harcamak", 5));
        solBölümList.add(new Tasarı("Try", "Denemek", 6));
        solBölümList.add(new Tasarı("Send", "Göndermek", 7));
        solBölümList.add(new Tasarı("Cheap", "Ucuz", 8));
        solBölümList.add(new Tasarı("Glasses", "Gözlük", 9));
        solBölümList.add(new Tasarı("Buckle", "Toka", 10));
        solBölümList.add(new Tasarı("Belt", "Kemer", 11));
        solBölümList.add(new Tasarı("Ship", "Gemi", 12));
        solBölümList.add(new Tasarı("Bridge", "Köprü", 13));
        solBölümList.add(new Tasarı("Vehicle", "Taşıt", 14));
        solBölümList.add(new Tasarı("Driver", "Sürücü", 15));
