...
public class Fragment1 extends Fragment {
    ...
    private void dialog() {
        ...
        new AlertDialog.Builder(Fragment1.this.context).setTitle("Good Job!")
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment1.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment1.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment1.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Bird", "Kuş", 0));
        solBölümList.add(new Tasarı("Milk", "Süt", 1));
        solBölümList.add(new Tasarı("Computer", "Bilgisayar", 2));
        solBölümList.add(new Tasarı("Telephone", "Telefon", 3));
        solBölümList.add(new Tasarı("Book", "Kitap", 4));
        solBölümList.add(new Tasarı("Pencil", "Kalem", 5));
        solBölümList.add(new Tasarı("Keyboard", "Klavye", 6));
        solBölümList.add(new Tasarı("Mountain", "Dağ", 7));
        solBölümList.add(new Tasarı("Sea", "Deniz", 8));
        solBölümList.add(new Tasarı("Clock", "Saat", 9));
        solBölümList.add(new Tasarı("Mirror", "Ayna", 10));
        solBölümList.add(new Tasarı("Table", "Masa", 11));
        solBölümList.add(new Tasarı("Bag", "Çanta", 12));
        solBölümList.add(new Tasarı("Car", "Araba", 13));
        solBölümList.add(new Tasarı("White", "Beyaz", 14));
        solBölümList.add(new Tasarı("Key", "Anahtar", 15));
