...
public class Fragment8 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment8.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment8.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment8.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Plum", "Erik", 0));
        solBölümList.add(new Tasarı("Peach", "Şeftali", 1));
        solBölümList.add(new Tasarı("Fish", "Balık", 2));
        solBölümList.add(new Tasarı("Meat", "Et", 3));
        solBölümList.add(new Tasarı("Chocolate", "Çikolata", 4));
        solBölümList.add(new Tasarı("Body", "Vücut", 5));
        solBölümList.add(new Tasarı("Knee", "Diz", 6));
        solBölümList.add(new Tasarı("Leg", "Bacak", 7));
        solBölümList.add(new Tasarı("Sink", "Lavabo", 8));
        solBölümList.add(new Tasarı("Flower", "Çiçek", 9));
        solBölümList.add(new Tasarı("Pond", "Gölet", 10));
        solBölümList.add(new Tasarı("Fence", "Çit", 11));
        solBölümList.add(new Tasarı("Bush", "Çalı", 12));
        solBölümList.add(new Tasarı("Vase", "Saksı", 13));
        solBölümList.add(new Tasarı("Engineer", "Mühendis", 14));
        solBölümList.add(new Tasarı("Mechanic", "Tamirci", 15));
