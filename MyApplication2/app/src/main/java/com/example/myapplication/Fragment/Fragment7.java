...
public class Fragment7 extends Fragment {
    ...
    private void reklamBaslat() {
        if (mInterstitialAd!=null){
            mInterstitialAd.show((Activity) Fragment7.this.context);
            gecisReklam();}
    }
    ...
    public void gecisReklam() {
        ...
        InterstitialAd.load(Fragment7.this.context,"ca-app-pub-2396996479721834/6543991034", adRequest,
    ...
    private void finish() {
        ...
        Intent eslestirBolumIntent = new Intent(Fragment7.this.context, eslestir_bolumler.class);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        solBölümList.add(new Tasarı("Strawberry", "Çilek", 0));
        solBölümList.add(new Tasarı("Blackberry", "Böğürtlen", 1));
        solBölümList.add(new Tasarı("Watermelon", "Karpuz", 2));
        solBölümList.add(new Tasarı("Salt", "Tuz", 3));
        solBölümList.add(new Tasarı("Olives", "Zeytin", 4));
        solBölümList.add(new Tasarı("Sugar", "Şeker", 5));
        solBölümList.add(new Tasarı("Honey", "Bal", 6));
        solBölümList.add(new Tasarı("Mug", "Kupa", 7));
        solBölümList.add(new Tasarı("Fork", "Çatal", 8));
        solBölümList.add(new Tasarı("Knife", "Bıçak", 9));
        solBölümList.add(new Tasarı("Spoon", "Kaşık", 10));
        solBölümList.add(new Tasarı("Throat", "Boğaz", 11));
        solBölümList.add(new Tasarı("Jaw", "Çene", 12));
        solBölümList.add(new Tasarı("Stomach", "Mide", 13));
        solBölümList.add(new Tasarı("Soap", "Sabun", 14));
        solBölümList.add(new Tasarı("Shower", "Duş", 15));
